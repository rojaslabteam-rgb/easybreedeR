...
TRANSLATIONS <- list(
  ...
  hero_secondary_1 = list(
    en = "Find your major →",
    zh = "查找你的专业 →",
    pt = "Encontre seu curso →"
  ),
  hero_secondary_2 = list(
    en = "Check tuition and costs →",
    zh = "查看学费与费用 →",
    pt = "Verifique taxas e custos →"
  ),
  hero_secondary_3 = list(
    en = "Schedule a visit →",
    zh = "预约参观 →",
    pt = "Agende uma visita →"
  ),
  ...
  language_button = list(
    en = "Language / 中文 / Português",
    zh = "语言 / Language / Português",
    pt = "Idioma / Language / 中文"
  ),
  ...
  easyblup_genotype = list(
    en = "Genotype Files (PLINK)",
    zh = "基因型文件 (PLINK)",
    pt = "Arquivos de Genótipo (PLINK)"
  ),
