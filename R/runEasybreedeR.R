#' Launch the easybreedeR Studio Suite
#'
#' @description
#' Main entry point for the easybreedeR Shiny application suite.
#' This function launches the main studio application which provides
#' access to all sub-applications.
#'
#' @export
...
#' Launch easybreedeR Studio
#'
#' @description
#' Launches the main easybreedeR Studio application (suite launcher).
#'
#' @export
#' @examples
#' \dontrun{
#'   run_easybreedeR_studio()
#' }
