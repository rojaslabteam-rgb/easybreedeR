...
#'
#' The functions `run_easybreedeR()` and `run_easybreedeR_studio()` are
#' synonyms; either may be used. Only one help page is generated to avoid
#' duplication.
#'
#' @name run_easybreedeR_studio
#' @aliases run_easybreedeR run_easybreedeR_studio
#' @export
#' @return A Shiny app object (invisibly returned by `shiny::runApp`).
#' @examples
#' \dontrun{
#'   run_easybreedeR()            # launch via primary name
#'   run_easybreedeR_studio()     # identical synonym
#' }
...
##' @rdname run_easybreedeR_studio
##' @export
run_easybreedeR_studio <- function() run_easybreedeR()
